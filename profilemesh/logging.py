"""
Structured JSON logging for ProfileMesh.
...
def init_logging(run_id: str, component: str = "profilemesh", level: str = "INFO") -> Any:
    """
    Initialize structured JSON logging for ProfileMesh.
...
def _init_stdlib_logging(run_id: str, component: str, level: str) -> Any:
    ...
    logger = logging.getLogger(f"profilemesh.{component}")
...
def get_logger(component: str = "profilemesh", run_id: Optional[str] = None) -> Any:
    """
