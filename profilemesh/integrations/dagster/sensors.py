"""
Plan-aware Dagster sensors for ProfileMesh.
...
if DAGSTER_AVAILABLE:
    ...
    def profilemesh_plan_sensor(
        *,
        ...
        """
        Build a plan-aware Dagster sensor for ProfileMesh assets.
        """
        ...
        def _plan_sensor(context: SensorEvaluationContext):
            ...
            if not changed_tables:
                ...
                context.log.info("ProfileMesh plan unchanged; sensor idle.")
                return
            ...
            run_request = RunRequest(
                ...
                tags={
                    "profilemesh/environment": snapshot["environment"],
                    "profilemesh/plan_signature": snapshot["signature"],
                    "profilemesh/changed_tables": json.dumps(changed_tables),
                    "profilemesh/metrics_requested": str(metrics_total),
                },
            )
