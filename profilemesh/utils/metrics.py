...
errors_total = Counter(
    "profilemesh_errors_total", "Total number of errors", ["warehouse", "error_type", "component"]
)
...
active_workers = Gauge(
    "profilemesh_active_workers", "Number of currently running worker threads", ["warehouse"]
)
...
worker_queue_size = Gauge(
    "profilemesh_worker_queue_size", "Current size of worker task queue", ["warehouse"]
)
...
rows_profiled_total = Counter(
    "profilemesh_rows_profiled_total", "Total number of rows profiled", ["warehouse", "table"]
)

columns_profiled_total = Counter(
    "profilemesh_columns_profiled_total", "Total number of columns profiled", ["warehouse", "table"]
)
