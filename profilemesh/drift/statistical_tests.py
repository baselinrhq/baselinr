"""
Statistical tests for advanced drift detection in ProfileMesh.
...
class StatisticalTest(ABC):
    ...
    @abstractmethod
    def compare(self, baseline_data: Any, current_data: Any) -> TestResult:
        """
        ...
        Returns:
            TestResult with test statistic, p-value, and drift detection
        """
        pass

    @abstractmethod
    def score(self, test_result: TestResult) -> float:
        """
