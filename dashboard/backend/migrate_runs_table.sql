-- Migration script to change profilemesh_runs primary key from run_id to (run_id, dataset_name)
-- This allows multiple tables to be profiled in the same run

-- Step 1: Drop the existing primary key constraint
ALTER TABLE profilemesh_runs DROP CONSTRAINT IF EXISTS profilemesh_runs_pkey;

-- Step 2: Add the new composite primary key
ALTER TABLE profilemesh_runs ADD PRIMARY KEY (run_id, dataset_name);
