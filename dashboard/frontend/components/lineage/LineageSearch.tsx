    ...
    <div ref={searchRef} className="relative">
            ...
            <div className="p-2">
              ...
              {searchResults.map((table) => (
                <button
                  ...
                  className="w-full px-3 py-2 text-left hover:bg-gray-100 focus:bg-gray-100 rounded transition-colors"
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      {table.provider && (
                        <div className="text-xs text-gray-400 mt-1">Provider: {table.provider}</div>
                      )}
                    </div>
                  </div>
                </button>
      ...
      {selectedTable && !searchQuery && (
        <div className="mt-2 p-2 bg-blue-50 rounded text-sm border border-blue-200">
          <div className="font-medium text-blue-900">{selectedTable.table}</div>
          {selectedTable.schema && (
            <div className="text-xs text-blue-600">{selectedTable.schema}</div>
          )}
        </div>
      )}
    </div>
