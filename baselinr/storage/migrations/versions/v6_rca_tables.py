...
def up_migration(conn):
    ...
    pipeline_run_indexes = [
        "CREATE INDEX IF NOT EXISTS idx_pipeline_runs_pipeline_name ON baselinr_pipeline_runs (pipeline_name)",
        "CREATE INDEX IF NOT EXISTS idx_pipeline_runs_started_at ON baselinr_pipeline_runs (started_at DESC)",
        "CREATE INDEX IF NOT EXISTS idx_pipeline_runs_status ON baselinr_pipeline_runs (status)",
        "CREATE INDEX IF NOT EXISTS idx_pipeline_runs_git_commit ON baselinr_pipeline_runs (git_commit_sha)",
    ]
    ...
    deployment_indexes = [
        "CREATE INDEX IF NOT EXISTS idx_code_deployments_deployed_at ON baselinr_code_deployments (deployed_at DESC)",
        "CREATE INDEX IF NOT EXISTS idx_code_deployments_git_commit ON baselinr_code_deployments (git_commit_sha)",
    ]
    ...
    rca_indexes = [
        "CREATE INDEX IF NOT EXISTS idx_rca_results_table_name ON baselinr_rca_results (table_name, schema_name)",
        "CREATE INDEX IF NOT EXISTS idx_rca_results_analyzed_at ON baselinr_rca_results (analyzed_at DESC)",
        "CREATE INDEX IF NOT EXISTS idx_rca_results_status ON baselinr_rca_results (rca_status)",
    ]
