...
class RootCauseAnalyzer:
    ...
    def analyze(
        ...
        try:
            pipeline_causes, deployment_causes = self.temporal_correlator.find_all_correlated_events(
        ...
        logger.info(
            f"RCA complete for {anomaly_id}. Found {len(filtered_causes)} probable causes."
        )
